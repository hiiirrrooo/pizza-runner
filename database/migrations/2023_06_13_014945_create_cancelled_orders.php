...
return new class extends Migration
{
    ...
    {
        \DB::statement("
        CREATE VIEW cancelled_orders AS SELECT DISTINCT c.customer_id AS CustID, cust.customer_name AS CustName, c.order_id AS OrderID, DATE(c.order_date) AS Dates
